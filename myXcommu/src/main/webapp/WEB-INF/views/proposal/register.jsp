...
<div class="content-wrapper">
	...
	<div class="row page-title-header">
		<div class="col-12">
			<div class="page-header">
				<h4 class="page-title" style="font-weight: 1000;">건의게시판 - 새글</h4>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<form class="forms-sample" method="post" id="proposalForm" action="registerProposal" enctype="multipart/form-data">
						<div class="form-group">
							<label for="questionSubject">제목</label> <input type="text" class="form-control" id="proposalSubject" name="subject" placeholder="제목을 적어주세요.">
						</div>
						<div class="form-group">
							<label for="questionDivision">구분</label>
							<select class="form-control" id="proposalDivision" name="division">
								<option value="사이트기능">사이트기능</option>
								<option value="게시판추가">게시판추가</option>
								<option value="버그발견">버그발견</option>
