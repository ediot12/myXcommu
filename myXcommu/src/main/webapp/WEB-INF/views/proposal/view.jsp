	...
	<div class="content-wrapper">
		...
		<div class="row page-title-header">
			<div class="col-12">
				<div class="page-header">
					<!-- <h4 class="page-title" style="font-weight: 1000;">건의게시판 - 게시글</h4> -->
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-12 grid-margin stretch-card">
				<div class="card">
					<h4 class="page-title" style="font-size : 10pt; color : gray; font-weight: 1000; margin-left: 30px; margin-top: 20px; margin-bottom: -30px;">건의게시판 >> 게시글</h4>
					<div class="card-body">
						<form class="forms-sample" method="post" action="/">
							...
							<div class="form-group">
								<textarea class="form-control" name="content" id="contentArea" rows="2" disabled="disabled"></textarea>
							</div>
							...
							<sec:authorize access="isAuthenticated()">
								<c:if test="${pinfo.username eq board.writer}">
									...
									<button type="button" class="btn btn-info btn-md" onclick="goModifyPage(${board.proposal_seq})"><i class="fa fa-edit"></i>수정</button>
								</c:if>
							</sec:authorize>
...
<script>
	...
	function goModifyPage( pageNum ){
		...
		location.href="/proposal/modify/"+pageNum;
	}
