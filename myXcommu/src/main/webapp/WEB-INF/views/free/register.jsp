...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<form class="forms-sample" method="post" action="registerFreeBoard" enctype="multipart/form-data">
						<div class="form-group">
							<label for="questionSubject">제목</label> <input type="text" class="form-control" id="freeSubject" name="subject" placeholder="제목을 적어주세요.">
						</div>
						<div class="form-group">
