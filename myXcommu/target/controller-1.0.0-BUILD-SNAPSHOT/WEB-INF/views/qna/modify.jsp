					...
					<div class="card-body">
						<form class="forms-sample" method="post" action="updateQuestion" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="questionSubject" name="subject" value="${board.subject }" placeholder="제목을 적어주세요.">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>첨부파일 </label> <!-- <input type="file" name="uploadFile" class="file-upload-default"> -->
								<div class="input-group col-xs-12">
									<input type="text" class="form-control" value="${fileInfo.file_name }" id="fileName" readonly="readonly" style="width: 200px; height: 20px;" />
									<i class="fa fa-times-circle" onclick="fileDelete()"></i>
							...
							<input type="hidden" id="fileDeleteYN" name="fileDeleteYN" value="N">
